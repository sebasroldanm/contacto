...
class cronenvioF extends MY_Controller {
    ...
    public function index() {
        ...
        else
        {
            ...
            if($data["cron"][0]["estado"] == 1)
            {
                ...
                $this->registraLog('cronenvioF', 'cronenvioProcess', $nuevo);
            }    
            else
            {
                $this->cronenvioIn($data["cron"][0]["id"]);
                    ...
                    while($contador < 55)
                    {
                        ...
                        {
                            echo $contador." - NO HAY MENSAJES PARA EL CANAL F<br>";
