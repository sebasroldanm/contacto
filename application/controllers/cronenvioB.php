...
class cronenvioB extends MY_Controller {
    ...
    public function index() {
        ...
        else
        {
            ...
            while($contador < 20)
		    {
                        ...
                        {
                            echo $contador." - NO HAY MENSAJES PARA EL CANAL B<br>";
