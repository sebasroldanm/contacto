...
class cronenvioC extends MY_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model("AdministradorModel");
        $this->load->library('smpp3');
    }
    ...
    public function index() {
        ...
        else
        {
            ...
            while($contador < 20)
		    {
                        ...
                        {
                            echo $contador." - NO HAY MENSAJES PARA EL CANAL C<br>";
                        ...
                        else 
                        {
                            ...
                            $data["smpp"] = $this->AdministradorModel->buscar('canales', 'host,port,usr,password,systemtype,nomenclatura,sourceaddress', $where);
