...
class cronenvioP extends MY_Controller {
            ...
            else
            {
                $this->cronenvioIn($data["cron"][0]["id"]);
                    ...
                    while($contador < 55)
                    {
                        ...
                        if ($tam == 0)
                        {
                            echo $contador." - NO HAY MENSAJES PARA EL CANAL P<br>";
                        ...
                        else 
                        {
                                ...
                                for ($i = 0; $i < $tam; $i++) {
                                    ...
                                    //inserta el registro
                                     $resultado =  $this->AdministradorModel->insert('sms_queue3', $datos_my, null,'mysql');
                                    ...
                                    if ($resultado) {
                                         ...
                                         * - Resumenes
                                         */
                                        $this->actualizar($data["pendientes"][$i]["id"],$data["pendientes"][$i]["idbase"],$data["pendientes"][$i]["idcarrie"],$data["pendientes"][$i]["numero"],$data["pendientes"][$i]["mensaje"],$data["pendientes"][$i]["nota"],$data["pendientes"][$i]["idcarrie"],$data["pendientes"][$i]["cargue"],'P',$data["pendientes"][$i]["fechacargue"]);
                                    }
