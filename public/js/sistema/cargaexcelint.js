$(function () {
    ...
    $("#subir").click(function () {
        ...
        if ($("#archivo").val() != '') {
            if ($("#prueba").is(":checked")) {
                ...
                var res = preCarga2("cargaexcelint/preCarga");
    ...
    $("#descargaExcel").click(function () {
        ...
        window.open('cargaexcelint/excelErrores/' + idbase, '_blank');
    });
    ...
    $("#continuar").click(function () {
        ...
        if ($("#habilitafecha").is(":checked")) {
            ...
            var res = crud(objeto, 'cargaexcelint/cargaExcel'), envioefectivo = 0;
            ...
            res.success(function (data) {
                ...
                $("#regbuenos").html('<a href="#" class="btn btn-success" onclick=verBase(' + data.idbase + ')>Ver Carga ' + data.ok + ' SMS</a>');
                ...
                if (data.cupo != "undefined") {
                    ...
                    envioefectivo = (data.cupo.disponible >= data.ok) ? data.ok : 0;
                    $("#regcupo").html('<b>' + envioefectivo + ' SMS</b>');
    ...
    $("#confirmacioncarga").click(function () {
        ...
        var res = crud(obj, 'cargaexcelint/procesarCarga');
        res.success(function (data) {
            $("#confirmacioncarga").attr("disabled", true);
            $(".alertaconfimacion").removeClass("hidden").html("<b>" + data.mensaje + "!</b>");
...
function verBase(id) {
    ...
    var res = crud(obj, 'cargaexcelint/verBase');
    res.success(function (data) {
...
function trash() {
    ...
    var res = crud(objeto, 'cargaexcelint/borrarArchivo');
}
...
function leerRegistros(objeto) {
    var res = crud(objeto, "cargaexcelint/cuentaRegistros");
    res.success(function (data) {
...
function traeRegistros(objeto) {
    var res = crud(objeto, "cargaexcelint/otroRegistros");
    res.success(function (data) {
